...
export default function SettingsPage() {
  const [profileImage, setProfileImage] = useState("https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80");
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <div className="border-b border-border pb-6">
        <h2 className="font-fraunces text-2xl font-normal text-foreground mb-2">Account Settings</h2>
        <p className="text-muted-foreground text-[11px] uppercase tracking-[0.1em]">Manage your profile, security and preferences.</p>
      </div>
