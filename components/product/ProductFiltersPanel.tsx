...
export function ProductFiltersPanel({ filters, filterOptions, onUpdate }: ProductFiltersPanelProps) {
  ...
  return (
    <div className="space-y-10">
      <div>
        <h3 className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground border-b border-border pb-3 mb-4 font-bold">Category</h3>
          ...
          {filterOptions.categories.map((cat) => (
            <div key={cat.slug} className="flex items-center gap-3">
              <Checkbox
                ...
                className="border-border data-[state=checked]:bg-[#cfae70] data-[state=checked]:border-[#cfae70] data-[state=checked]:text-black rounded-none"
              />
              <label htmlFor={`cat-${cat.slug}`} className="text-[11px] text-foreground hover:text-[#cfae70] uppercase tracking-[0.1em] cursor-pointer transition-colors leading-none pt-0.5">
                {cat.name}
              </label>
            </div>
          ))}
      ...
      <div>
        <h3 className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground border-b border-border pb-3 mb-6 font-bold">Price Range</h3>
        <Slider
        ...
        />
        <div className="flex justify-between text-[11px] uppercase tracking-[0.1em] text-muted-foreground mt-4">
      ...
      <div>
        <h3 className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground border-b border-border pb-3 mb-4 font-bold">Size</h3>
      ...
      <div>
        <h3 className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground border-b border-border pb-3 mb-4 font-bold">Color</h3>
        <div className="flex flex-wrap gap-2">
